...
DATABASES =  { 'default': dj_database_url.config(default='postgres://hackaton@localhost:5432/hackaton') }
...
SECRET_KEY = 'gi%r0*5rhooe#asy516qcs1qpjv2xo&pybxs(x-p=k&uc@8$+3'
